...
/**
 * Servlet implementation class TaskHandler. This is the worker for the Push
 * Queue. It will complete the tasks added to the Task Queues.
 */
@WebServlet("/taskqueues/worker")
